                ...
                <tbody>
                    <?php $__currentLoopData = $qcm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qcm_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <p class="text-align-center flex"><?php echo e($qcm_->user()->username); ?></p>
                            </td>
                            <td>
                                <p class="text-align-center flex"><?php echo e($qcm_->diff()); ?></p>
                            </td>
                        </tr>
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <p class="text-align-center flex"><?php echo e($user->username); ?> (<?php echo e($user->username_discord); ?>)
                                </p>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex items-center">
                <div class="ml-4 text-lg leading-7 "><a href="#" class=" text-gray-900 text-dark">Questions</a>
                    <a class="btn btn-primary btn-sm"
                        href="<?php echo e(route('question.view')); ?>">Ajouter</a>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm"
                                    href="<?php echo e(route('question.edit', ['question' => $question->id])); ?>">Editer</a>
                                <a class="btn btn-danger btn-sm"
                                    href="<?php echo e(route('question.delete', ['question' => $question->id])); ?>">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($qcm->isEmpty()): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hugoj\Desktop\panel\resources\views/admin.blade.php ENDPATH**/ ?>